...
namespace RepositoryBiblioteca.Repository
{
    public class Libri : IOggetti<Libro>
    {
        public bool Delete(int idLibro)
        {
            ...
            {
                LogError.Write(Ex.Message, "Libri", "DeleteLibro");
                return false;
            }
        }
...

        {
            ...
            {
                LogError.Write(error.Message, "Libri", "GetLibro");
                return null;
            }
        }
        ...
        public int Insert(Libro libro)
        {
            ...
            {
                LogError.Write(error.Message, "Libri", "InsertLibro");
                return -1;
            }
        }
        ...
        public bool Update(Libro libro)
        {
            ...
            {
                LogError.Write(Ex.Message, "Libri", "UpdateLibri");
                return false;
            }
        }
    }
